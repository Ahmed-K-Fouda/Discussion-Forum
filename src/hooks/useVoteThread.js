...
export default function useVoteThread({
  threadDetail,
  authUser,
  buttonClicked,
}) {
  ...
  function upVote() {
    if (!localStorage.accessToken) {
      return toast.error("يحب عليك تسجيل الدخول للمتابعه!");
    }
